...
import com.app.oldermore.alarm.preferences.AlarmPreference.Type;
...
public class AlarmPreferenceListAdapter extends BaseAdapter implements Serializable {
	...
	private final String[] repeatDays = {"อาทิตย์","จันทร์","อังคาร","พุธ","พฤหัส","ศุกร์","เสาร์"};
	private final String[] alarmDifficulties = {"น้อย","ปานกลาง","มาก"};
